...
fn identity_records_record_reference_tokens_are_domain_separated_and_exact() {
  ...
  let golden: [u8; 32] = [
    0xE2, 0x0B, 0xBF, 0xB1, 0x05, 0x71, 0x74, 0xF4, 0x93, 0x20, 0x09, 0x02, 0x82, 0xD8, 0x50, 0x1A,
    0x46, 0xEF, 0x00, 0xDB, 0x28, 0xD4, 0x96, 0x3A, 0x01, 0x33, 0x03, 0x05, 0x58, 0x0D, 0x93, 0xF9,
  ];
  assert_eq!(
    owner,
