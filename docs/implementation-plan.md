...
| T-G01-05 G1 facade/MSRV/lint closure | P0/M | 01-01..04 | Facade proof, Rust 1.97.1/stable jobs, locked deps, deny checks and production panic denials | `src/lib.rs`, `test-support/src/lib.rs`, `tests/foundation_public.rs`, `deny.toml`, `scripts/verify-g1-closure.sh`, `.github/workflows/quality_check.yml` | SC-G01-P0-06..07; external facade lifecycle, private/absent path doctests, MSRV/stable locked Q, cargo-deny and Clippy `-D warnings` | R0 |
