...
| T-G01-04 Unified failure artifact/replay | P0/M | 01-03 | Implement bounded allowlisted artifact schema and closed replay argv for every test producer | `src/simulation/{mod,scenario,fixture,artifact,redaction}.rs`, `tests/fixtures/failure-artifacts/*` | SC-G01-P0-04..05; forbidden-field/injection/truncation/normalization and byte-stable simulation tests | R0 |
