...
[[ $MANIFEST_DIGEST == 0bd2de688031e10d08f0e9f1e41c5eb0771ab3be45c3c8de39c376b16c599ac9 ]] || {
...
digest@0.11.3 source=registry+https://github.com/rust-lang/crates.io-index features=alloc,block-api,default,oid,rand_core
